...
class SanitiserTests(unittest.TestCase):
    ...
    def test_path_leak_detection(self):
    ...
    def test_telescope_downgrade(self):
        cases = {
    ...
    def test_object_name_suspicious_value(self):
        src = {
            "scan_date": "2026-04-19T00:00:00",
            "targets": [{
                "target_id": 1,
    ...
    def test_sanitised_flag_and_label(self):
    ...
    def test_full_synthetic_validates(self):
